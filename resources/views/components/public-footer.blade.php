<footer class="bg-slate-900 text-slate-300">
        ...
        <div>
            ...
            <ul class="mt-4 space-y-3 text-sm">
                ...
                <li class="flex gap-2">
                    ...
                    <a href="mailto:{{ settings('site.email') }}" class="hover:text-gold-400">{{ settings('site.email', '-') }}</a>
                </li>
                <li class="flex gap-2">
                    <svg class="mt-0.5 h-4 w-4 shrink-0 text-gold-400" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                ...
                <li>
                    <a
                        ...
                        class="inline-flex items-center gap-1.5 rounded-full bg-gold-500 px-4 py-1.5 text-xs font-bold text-slate-900 transition hover:bg-gold-400"
                    >
                        Lapor! SP4N-LAPOR
    ...
    <div class="border-t border-white/10">
        <div class="mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-4 py-4 text-xs sm:flex-row sm:px-6 lg:px-8">
